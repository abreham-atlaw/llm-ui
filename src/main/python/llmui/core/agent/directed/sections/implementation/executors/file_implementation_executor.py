...
class FileImplementationExecutor(LLMExecutor[typing.Tuple[str, str, str, typing.Dict[str, str]], str]):
...
"""
	...
	def _prepare_prompt(self, arg: typing.Tuple[str, str, str, typing.Dict[str, str]]) -> str:
		project_description, file, description, dependencies = arg
		return f"""
...
"""
	...
	def _prepare_output(self, output: str, arg: typing.Tuple[str, str, str, typing.Dict[str, str]]) -> str:
